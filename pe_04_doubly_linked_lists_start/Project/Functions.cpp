...
void DoublyList::reversePrint() const
{
	...
	{
		Node *current = last;  //set current to point to the last node
...
// CREATE TESTING CASES <========================== DO THIS WITH STUDENTS

// insertInOrder
void DoublyList::insertInOrder(int insertItem)  // <= LET STUDENTS DO THIS
{
